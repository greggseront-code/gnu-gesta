...
#
# Usage: ./deploy-prod.sh [--env production|staging] [--skip-git] [-h|--help]
# Relaie tous les arguments a deploy.sh sur le VPS ; voir deploy.sh -h pour
# le detail de chaque option.
set -euo pipefail
