...
* Spec : `docs/specs/2026-07-30-deploiement-semi-automatise.md`
* README de feature : -
...
* Mise à jour de `docs/deployment.md` : sections Backend/Nginx pointent
...
* `docs/deployment.md` (mis à jour)
* `docs/specs/2026-07-30-deploiement-semi-automatise.md` (nouveau)
...
* La procédure d'ajout d'un nouveau sous-domaine n'a pas été automatisée
  ...
  comme étapes manuelles dans `docs/deployment.md`.
