...
> `docs/operations/production-readiness.md` pour la décision à reprendre avant une
...
`docs/operations/production-readiness.md`, indépendamment de la décision de le séparer
...
(`docs/history/phases/2026-07-31-authentification-microsoft-entra-v1-spec.md`), les
...
* Voir `docs/history/phases/2026-07-31-deploy-node-env-configurable-spec.md` pour le détail
  de cette évolution.
...
* Spec (mise en place HTTPS) : `docs/history/phases/2026-07-30-https-reverse-proxy-gng-spec.md`
* Review (mise en place HTTPS) : `docs/history/reviews/2026-07-30-https-reverse-proxy-gng.md`
* Spec (déploiement semi-automatisé) : `docs/history/phases/2026-07-30-deploiement-semi-automatise-spec.md`
* Review (déploiement semi-automatisé) : `docs/history/reviews/2026-07-30-deploiement-semi-automatise.md`
* Spec (environnement runtime configurable) : `docs/history/phases/2026-07-31-deploy-node-env-configurable-spec.md`
* Spec (pilote authentification Microsoft Entra) : `docs/history/phases/2026-07-31-authentification-microsoft-entra-v1-spec.md`
* Architecture applicative : `docs/current/architecture.md`
