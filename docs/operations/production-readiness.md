...
* Voir `docs/operations/deployment.md`, section "Secrets authentification Microsoft
...
**État actuel** (voir `docs/history/reviews/2026-07-31-authentification-microsoft-entra-v1.md`,
...
* **`/etc/gnu-gesta/backend.env`** doit exister avec les permissions `600`
  ...
  `docs/operations/deployment.md`), ce qui est le comportement voulu mais à anticiper
  lors du tout premier déploiement.

## Documents liés

* Déploiement : `docs/operations/deployment.md`
* Spec authentification : `docs/history/phases/2026-07-31-authentification-microsoft-entra-v1-spec.md`
* Plan authentification : `docs/history/phases/2026-07-31-authentification-microsoft-entra-v1-plan.md`
* Review jalons 2-7 : `docs/history/reviews/2026-07-31-authentification-microsoft-entra-v1.md`
