...
- `docs/history/reviews/2026-06-18-architecture-bird-eye-refactor.md`
...
- `docs/current/architecture.md` conserve une vue globale: vision, stack, principes,
...
- Certains libelles ont ete reformules pour reduire la longueur de
  `docs/current/architecture.md`; les details correspondants sont conserves dans les
  README de features.
