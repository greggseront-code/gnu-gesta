...
* Modele de donnees : `docs/current/data-model.md`
...
* Ajout d'une section de references documentaires dans `docs/current/architecture.md`.
...
* Lecture de `CLAUDE.md`, `README.md`, `docs/current/architecture.md`,
  `docs/current/features.md`, `docs/current/data-model.md`, des README backend de features et
...
* Faut-il completer le plan documentaire non suivi
  `docs/history/phases/2026-06-20-feature-documentation-light-refactor-plan.md` ou le laisser
