...
- `docs/history/reviews/2026-06-18-documentation-restructure.md`
...
- `docs/history/phases/2026-05-15-gestion-stages-v1-design-spec.md`
- `docs/history/phases/2026-05-15-gestion-stages-v1-technical-design-spec.md`
...
- La stack, les principes techniques, l'organisation backend et les conventions
  de nommage ont ete deplaces vers `docs/current/architecture.md`.
- Les objets metier centraux, les statuts et les regles d'acces globales ont ete
  resumes dans `docs/current/architecture.md`.
