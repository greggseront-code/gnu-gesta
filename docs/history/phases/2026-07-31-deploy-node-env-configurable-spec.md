...
`docs/history/phases/2026-07-31-authentification-microsoft-entra-v1-spec.md` et
`docs/history/phases/2026-07-31-authentification-microsoft-entra-v1-plan.md`) refuse
...
`docs/operations/deployment.md`). L'utilisateur souhaite s'en servir comme
...
(voir la review `docs/history/reviews/2026-07-31-authentification-microsoft-entra-pilot.md`).
...
(`docs/history/phases/2026-07-30-deploiement-semi-automatise-spec.md`) excluait
...
* Mise à jour de `docs/operations/deployment.md`.
...
* [ ] `docs/operations/deployment.md` documente le nouveau comportement et le fichier
      `/etc/gnu-gesta/deploy-env.conf`.
...
* Spec précédente (déploiement semi-automatisé) :
  `docs/history/phases/2026-07-30-deploiement-semi-automatise-spec.md`
* Spec liée (pilote authentification) :
  `docs/history/phases/2026-07-31-authentification-microsoft-entra-v1-spec.md`
* Plan lié : `docs/history/phases/2026-07-31-authentification-microsoft-entra-v1-plan.md`
* Review : `docs/history/reviews/2026-07-31-deploy-node-env-configurable.md` (à
