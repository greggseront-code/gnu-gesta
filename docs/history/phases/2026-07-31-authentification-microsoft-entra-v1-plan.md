...
`docs/history/reviews/2026-07-31-authentification-microsoft-entra-v1.md` pour le
...
* Create: `docs/history/reviews/2026-07-31-authentification-microsoft-entra-pilot.md`
...
* [x] Charger `/etc/gnu-gesta/backend.env` via systemd avec permissions `600`.
      *(directive systemd + procédure documentée ; la création effective du
      ...
      voir docs/operations/deployment.md)*
...
* [x] Renseigner l'URI de production déjà enregistrée et un secret destiné au
      VPS, sans copier le `.env` local. *(documenté dans docs/operations/deployment.md ;
...
* Create: `docs/history/reviews/2026-07-31-authentification-microsoft-entra-v1.md`
...
* Travail restant : validation manuelle des quatre profils (gestionnaire,
  ...
  `docs/history/reviews/2026-07-31-authentification-microsoft-entra-v1.md`.
