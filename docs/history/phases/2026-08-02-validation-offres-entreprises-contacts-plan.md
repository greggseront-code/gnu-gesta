...
Statut : implémenté (voir `docs/history/reviews/2026-08-02-validation-offres-entreprises-contacts.md`)
...
* Review précédente : `docs/history/reviews/2026-07-31-authentification-microsoft-entra-v1.md`
...
* Modify: `docs/current/data-model.md`
* Modify: `docs/history/analyses/company-departments.md`
* Verify: `docs/current/architecture.md`
* Verify: `docs/history/phases/2026-08-02-validation-offres-entreprises-contacts-spec.md`
* Modify: `docs/history/phases/2026-08-02-validation-offres-entreprises-contacts-plan.md`
* Create: `docs/history/reviews/2026-08-02-validation-offres-entreprises-contacts.md`
...
* [x] Mettre à jour les parcours et cas limites frontend dans la carte des
  features.
* [x] Conserver dans `docs/history/analyses/company-departments.md` la piste d'un modèle de
...
* Un nouvel agent peut retrouver depuis `docs/current/features.md` le parcours, les
