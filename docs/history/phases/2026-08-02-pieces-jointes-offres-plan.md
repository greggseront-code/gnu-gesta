...
* Spec : `docs/history/phases/2026-08-02-pieces-jointes-offres-spec.md`
...
* Review précédente :
  `docs/history/reviews/2026-06-20-context-engineering-comments.md`
...
* Documentation : `docs/current/features.md`, `docs/current/data-model.md`, README backend,
  éventuelle limite locale dans `docs/operations/production-readiness.md`, puis review.
...
* Create: `docs/history/reviews/2026-08-02-pieces-jointes-offres.md`
...
* Run: `cd frontend && npm run build`
* Run: `rg -n "attachment_path|/attachment\\b" backend/src backend/tests frontend/src docs/current/features.md docs/current/data-model.md backend/src/features/offers/README.md`
