...
versionnés — voir `docs/operations/deployment.md`) doivent devenir la source de vérité
...
* Mise à jour de `docs/operations/deployment.md` pour documenter le nouveau workflow.
...
* README de feature : -
* Review : `docs/history/reviews/2026-07-30-deploiement-semi-automatise.md` (à créer
  en fin de tâche)
