...
* liens vers `docs/current/features.md` et `docs/current/data-model.md` ;
* questions ouvertes.
...
* permissions ;
* tests back ;
* lien vers `docs/current/features.md` et `docs/current/data-model.md`.
...
* [x] Relire `docs/current/architecture.md`.
...
* [x] Creer `docs/templates/features-map-template.md` pour `docs/current/features.md`.
* [x] Creer `docs/templates/data-model-template.md` pour `docs/current/data-model.md`.
...
* [x] Creer `docs/current/features.md`.
...
* [x] Creer `docs/current/data-model.md`.
...
* [x] Verifier que chaque README backend contient :
  ...
  * [x] `Tests back`
  * [x] `Documents lies`
* [x] Ajouter un lien vers `docs/current/features.md`.
* [x] Ajouter un lien vers `docs/current/data-model.md`.
...
* [ ] Mettre a jour `docs/current/architecture.md` avec la structure documentaire legere.
* [ ] Mentionner `docs/current/features.md` comme carte produit front/back.
* [ ] Mentionner `docs/current/data-model.md` comme reference DB globale.
* [ ] Verifier que `docs/current/architecture.md` reste une vue globale courte.

### 7. Review

* [ ] Creer `docs/history/reviews/2026-06-20-feature-documentation-light-refactor.md`.
...
etre deplacees vers `docs/current/features.md`, pas vers des README frontend.

Les informations DB actuellement dispersees dans les README backend doivent etre
resumees localement dans `Acces donnees`, puis reliees a `docs/current/data-model.md`.
...
* Le frontend est documente dans `docs/current/features.md` pour cette V1 legere.
